...
jbcoe::polymorphic_value<DataType> BinOp::check_type() const { 
    const jbcoe::polymorphic_value<DataType> &lhs_type = m_lhs->check_type(), &rhs_type = m_rhs->check_type();
    ...
    jbcoe::polymorphic_value<DataType> res = Semantic::binop_check(m_op_id, lhs_type, rhs_type);
...
jbcoe::polymorphic_value<DataType> UnOp::check_type() const { 
    ...
    jbcoe::polymorphic_value<DataType> res = Semantic::unop_check(m_op_id, expr_type);
