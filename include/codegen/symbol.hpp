...
class SymbolTable {
   private:
    ...
    std::vector<std::unordered_map<std::string, structs::TypeValuePair>>
        m_scopes;
    std::unordered_map<std::string, structs::LocProtoFuncTriple>
        m_declared_functions;
    std::unordered_map<std::string, structs::LocProtoFuncTriple>
        m_defined_functions;
   ...
   public:
    ...
    std::optional<structs::TypeValuePair> get_var_curr_scope_only(
        std::string id);
    ...
    std::optional<structs::Error> declare_function(
        std::string id, structs::LocProtoFuncTriple lpf);
    std::optional<structs::Error> define_function(
        std::string id, structs::LocProtoFuncTriple tv);
