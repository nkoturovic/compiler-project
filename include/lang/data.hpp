...
private:
    ...
    inline const static std::map <DataTypeId, DataRepresent> m_type_to_represent_table = {
...
public:
    static DataRepresent type_to_represent(const jbcoe::polymorphic_value<DataType> &type);
    ...
    static Data convert(const Data &data, const jbcoe::polymorphic_value<DataType> &res_type);
    static Data do_bin_op(BinOpId op, const Data &lhs, const Data &rhs, const jbcoe::polymorphic_value<DataType> &res_type);
    static Data do_un_op(UnOpId op, const Data &expr, const jbcoe::polymorphic_value<DataType> &res_type);
